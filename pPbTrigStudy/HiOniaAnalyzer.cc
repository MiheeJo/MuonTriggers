...
private:
  ...
  enum StatBins {
    BIN_nEvents = 0,
    BIN_HLT_PAL1DoubleMu0_HighQ_v1 = 1,
    BIN_HLT_PAL1DoubleMuOpen_v1 = 2,
    BIN_HLT_PAMu1_Track1_Mgt2_v1 = 3,
    BIN_HLT_PAMu3_Track1_Mgt2_v1 = 4,
    BIN_HLT_PAL2DoubleMu3_v1 = 5,
    BIN_HLT_PAL2Mu3_NHitQ_v1 = 6,
    BIN_HLT_PAMu3_v1 = 7,
    BIN_HLT_PAMu7_v1 = 8,
    BIN_HLT_PAMu12_v1 = 9
  };

/*    BIN_HLT_PAL1DoubleMuOpenSingleAND_v1 = 1,
    BIN_HLT_PAMu1_Track1_Mgt2_v1 = 2,
    BIN_HLT_PAMu3_Track1_Mgt2_v1 = 3,
    BIN_HLT_PAL1SingleMuOpen_v2 = 4,
    BIN_HLT_PAMu1_v1 = 5,
    BIN_HLT_PAL1SingleMu3_v2 = 6,
    BIN_HLT_PAMu3_v1 = 7,
    BIN_HLT_PAL1SingleMu7_v2 = 8,
    BIN_HLT_PAMu7_v1 = 9,
    BIN_HLT_PAL1SingleMu12_v2 = 10,
    BIN_HLT_PAL1DoubleMu0_v2 = 11,
    BIN_HLT_PAL1DoubleMu0_HighQ_v1 = 12,
    BIN_HLT_PAL2Mu3_NHitQ_v1 = 13,
    BIN_HLT_PAL2DoubleMu0_v1 = 14,
    BIN_HLT_PAL2DoubleMu0_NHitQ_v1 = 15,
    BIN_HLT_PAL2DoubleMu0_L1HighQL2NHitQ_v1 = 16  */
 ...
 // Triger stuff
  ...
  static const unsigned int sNTRIGGERS = 15;
  ...
  _iConfig(iConfig)
{
  ...
  HLTLastFilters[1] = "hltPADoubleMuLevel1PathL1HighQFiltered";
  theTriggerNames.push_back("HLT_PAL1DoubleMu0_HighQ_v1");

  HLTLastFilters[2] = "hltL1fL1sL1DoubleMuSingleANDL1f0";
  theTriggerNames.push_back("HLT_PAL1DoubleMuOpen_v1");

  HLTLastFilters[3] = "hltMu1Track1Mgt2TrackMassFiltered";
  theTriggerNames.push_back("HLT_PAMu1_Track1_Mgt2_v1");

  HLTLastFilters[4] = "hltMu3Track1Mgt2TrackMassFiltered";
  theTriggerNames.push_back("HLT_PAMu3_Track1_Mgt2_v1");

  HLTLastFilters[5] = "hltPAL2DoubleMu3L2Filtered";
  theTriggerNames.push_back("HLT_PAL2DoubleMu3_v1");

  HLTLastFilters[6] = "hltPAL2Mu3NHitL2Filtered";
  theTriggerNames.push_back("HLT_PAL2Mu3_NHitQ_v1");

  HLTLastFilters[7] = "hltL3fL1sMu3L3Filtered3";
  theTriggerNames.push_back("HLT_PAMu3_v1");

  HLTLastFilters[8] = "hltL3fL1sMu7L3Filtered7";
  theTriggerNames.push_back("HLT_PAMu7_v1");

  HLTLastFilters[9] = "hltPAMu12L3Filtered12";
  theTriggerNames.push_back("HLT_PAMu12_v1");


/*  HLTLastFilters[1] = "hltL1fL1sL1DoubleMuSingleANDL1f0";
  theTriggerNames.push_back("HLT_PAL1DoubleMuOpenSingleAND_v1");
  
  HLTLastFilters[2] = "hltMu1Track1Mgt2TrackMassFiltered";
  theTriggerNames.push_back("HLT_PAMu1_Track1_Mgt2_v1");
  
  HLTLastFilters[3] = "hltMu3Track1Mgt2TrackMassFiltered";
  theTriggerNames.push_back("HLT_PAMu3_Track1_Mgt2_v1");
  
  HLTLastFilters[4] = "hltL1MuOpenL1Filtered0";
  theTriggerNames.push_back("HLT_PAL1SingleMuOpen_v2");
  
  HLTLastFilters[5] = "hltPAMu1L3Filtered1";
  theTriggerNames.push_back("HLT_PAMu1_v1");
  
  HLTLastFilters[6] = "hltL1fL1sMu3L1Filtered0";
  theTriggerNames.push_back("HLT_PAL1SingleMu3_v2");
  
  HLTLastFilters[7] = "hltL3fL1sMu3L3Filtered3";
  theTriggerNames.push_back("HLT_PAMu3_v1");

  HLTLastFilters[8] = "hltL1fL1sMu7L1Filtered0";
  theTriggerNames.push_back("HLT_PAL1SingleMu7_v2");

  HLTLastFilters[9] = "hltL3fL1sMu7L3Filtered7";
  theTriggerNames.push_back("HLT_PAMu7_v1");
  
  HLTLastFilters[10] = "hltL1fL1sMu12L1Filtered0";
  theTriggerNames.push_back("HLT_PAL1SingleMu12_v2");
  
  HLTLastFilters[11] = "hltL1fL1sL1DoubleMu0L1f0";
  theTriggerNames.push_back("HLT_PAL1DoubleMu0_v2");
  
  HLTLastFilters[12] = "hltPADoubleMuLevel1PathL1HighQFiltered";
  theTriggerNames.push_back("HLT_PAL1DoubleMu0_HighQ_v1");
  
  HLTLastFilters[13] = "hltPAL2Mu3NHitL2Filtered";
  theTriggerNames.push_back("HLT_PAL2Mu3_NHitQ_v1");

  HLTLastFilters[14] = "hltPAL2DoubleMu0L2Filtered";
  theTriggerNames.push_back("HLT_PAL2DoubleMu0_v1");

  HLTLastFilters[15] = "hltPAL2DoubleMu0L2N1HitsFiltered";
  theTriggerNames.push_back("HLT_PAL2DoubleMu0_NHitQ_v1");

  HLTLastFilters[16] = "hltPAL2DoubleMu0L2N1HitsFiltered";
  theTriggerNames.push_back("HLT_PAL2DoubleMu0_L1HighQL2NHitQ_v1");  */
...
HiOniaAnalyzer::checkTriggers(const pat::CompositeCandidate* aJpsiCand) {
  ...
  for (unsigned int iTr = 1; iTr<NTRIGGERS; ++iTr) {
    ...
    std::cout << mu1HLTMatchesFilter.size() << " " << mu1HLTMatchesFilter.size() << std::endl;
...
//    if (iTr == 1 || iTr == 11 || iTr == 12 || iTr == 14 || iTr == 15 || iTr == 16) { //double mu triggers
    if (iTr == 1 || iTr == 2 || iTr == 5) { //double mu triggers
      isTriggerMatched[iTr] = pass1 && pass2;
    } else {
      isTriggerMatched[iTr] = pass1 || pass2;
    }

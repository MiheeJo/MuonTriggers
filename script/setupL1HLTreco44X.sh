...
hltGetConfiguration /users/miheejo/test1/442HIonV30/V1 --data --unprescale --cff --offline --process HLT > $CMSSW_BASE/src/HLTrigger/Configuration/python/HLT_HIon_l3Mu_cff.py 
